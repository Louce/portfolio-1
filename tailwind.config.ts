...
export default {
  ...
  theme: {
    extend: {
      fontFamily: {
        // Use CSS variable from next/font for Inter
      ...
      animation: {
        ...
        'unfold-in': 'unfold-in 0.7s ease-out forwards',
        'unfold-out': 'unfold-out 0.7s ease-in forwards',
        ...
        'gradient-xy': 'gradient-xy 10s ease infinite alternate',
      },
    },
  },
