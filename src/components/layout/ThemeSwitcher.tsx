...
/**
 * A theme-switching button that provides a simple, smooth, and responsive
 * cross-fade transition between light and dark modes. This definitive version
 * removes complex animations in favor of a clean, performant, and reliable
...
export function ThemeSwitcher() {
  ...
  // Prevent hydration errors by ensuring the component is only rendered on the client.
  React.useEffect(() => {
    setIsMounted(true);
  }, []);

  // Render a disabled placeholder on the server to maintain layout and prevent layout shift.
  if (!isMounted) {
    return (
      <Button
        variant="ghost"
