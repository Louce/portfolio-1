    ...
    <section id="hero" className="relative flex flex-col min-h-screen w-full items-center justify-center text-foreground overflow-hidden pointer-events-auto">
      ...
      >
        <motion.h1
          ...
          className="flex justify-center text-center pt-16 md:pt-0 font-headline text-5xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-display-xl font-bold tracking-tight text-primary drop-shadow-md dark:drop-shadow-lg [perspective:800px]"
        >
